...
/*   Updated: 2022/10/28 21:29:58 by mskerba          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	light.position = create_tuple(-4.0, 5.0, -10.0, 1.0);
	world.light = &light;
	world.objects = NULL;
	...
	add_object(&world.objects, 'e', rotation_z(-M_PI / 2));
	world.objects->t = matrix_multi(translation(-5, 0.0, 0.0), world.objects->t, 4, 4);
	world.objects->inv = inverse_matrix(world.objects->t);
	world.objects->inv = trim_matrix(world.objects->inv);
	world.objects->transp = transpose_matrix(world.objects->inv, 4);
	...
	// add_object(&world.objects, 'c', scaling(1.0, 1.0, 1.0));
