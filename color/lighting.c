...
/*   Updated: 2022/10/30 22:06:38 by momeaizi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	phong.effective_c = multiply_tuple(&light->intensity, &comps->ambient.color);
// 	phong.ambient = scalar_multi(phong.effective_c, comps->ambient.ambient);
// 	if (shadowed)
...
// 	comps->obj->m.diffuse * phong.light_dot_norm);
